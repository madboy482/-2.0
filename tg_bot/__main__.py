...
PM_START_TEXT = """
**Hello {}, My Name is {}!** 
I am an **SUPERB**  group bot. Devloped by @pranavjha1 feel free to add me to your group😀😉✅😎!
...
TECHNO_IMG = "https://telegra.ph/file/369e2175dd2c2144e8a05.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/pranavjha1")],
                                                                                   [InlineKeyboardButton(text="ADD Ultra max TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/pranavjha2426/GRANDROBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Yuss, I am online as always 😎😉😀✅😊")
